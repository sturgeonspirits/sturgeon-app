    ...
    <div className="space-y-4">
      ...
      {selectedET && (
        <div className="bg-[#FFFFFF] border border-[#D4CFC3] rounded-xl p-4 space-y-4">
          <div className="flex items-center justify-between">
            ...
            {!activePeriod && (
              <button
                ...
                className="text-xs bg-[#96321F] text-[#FFFFFF] font-bold px-3 py-1.5 rounded-lg hover:bg-[#ae3a24] transition-colors"
              >
                Start Period
              </button>
            )}
          ...
          {!activePeriod ? (
            <p className="text-sm text-[#7E613F]">No active period. Start one to enter scores.</p>
          ) : (
            <>
